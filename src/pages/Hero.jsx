...
const Hero = () => {
    ...
    return (
        <section className='page flex items-center relative overflow-hidden'>
            ...
            <div className="container mx-auto z-0 pt-16">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="order-2 lg:order-1 px-4 md:px-16 lg:px-0">
                        <div className="space-y-6">
                            <div className='font-tech'>
                                ...
                                <h1 className="cyber-glitch w-full text-4xl sm:text-5xl md:text-6xl font-cyber font-bold tracking-tighter my-6" data-text={t('hero.title')}>
                                    {t('hero.title')}
                                </h1>
                            ...
                            <div className="flex flex-col md:flex-row gap-1 md:gap-4 pt-4">
                                ...
                                <AnimatedBtn text={t('hero.connect')} onClick={handleContactClick} className="text-lg font-digital w-full md:text-xl md:w-1/3 relative cursor-pointer inline-flex items-center justify-center px-3 py-1 md:px-4 md:py-2 overflow-hidden  font-bold text-dark bg-highlight border-2 border-highlight transform transition-all duration-300 ease-out hover:scale-105 hover:shadow-highlight focus:outline-none focus:ring-2 focus:ring-highlight focus:ring-opacity-50" textColor="text-black" />
                                <AnimatedBtn text={t('hero.view_projects')} onClick={handleProjectsClick} className="text-lg font-digital w-full md:text-xl md:w-1/3 relative cursor-pointer inline-flex items-center justify-center px-4 py-2 overflow-hidden  font-bold text-white bg-transparent border-2 border-white transform transition-all duration-300 ease-out hover:bg-white/10 hover:scale-105 hover:shadow-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50" textColor="text-white" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="order-1 w-full  lg:order-2">                        
                            ...
                            alt="Glitched Avatar"
                            loading="lazy"
                            className="w-[300px] h-[500px] mx-auto md:w-auto md:h-[600px]"
                            />
                    </div>
