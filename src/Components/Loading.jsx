...
const Loading = () => {
  return (
    <div className="min-h-screen w-full bg-black/95 font-digital text-gray relative overflow-hidden flex items-center justify-center">
      
      {/* Same background as MainLayout */}
      <CyberpunkBackground />
